...
func NewMaxMindProvider(cityPath, countryPath, asnPath string) (*MaxMindProvider, error) {
	...
	return &MaxMindProvider{cityDB: cityDB, countryDB: countryDB, asnDB: asnDB}, nil
}
...
func (p *MaxMindProvider) Query(ipStr string) (*MaxMindResult, error) {
